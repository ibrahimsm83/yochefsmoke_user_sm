...
import 'package:ycsh/view/registration/forgetpassword.dart';
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Visibility(
                visible: media.viewInsets.bottom == 0.0, child: buildBottom()),
          ],
        ),
      ),
    ));
...
/*        Expanded(
          child: Row(children: [
            ...
            TappableText(
              ...
              onTap: () {
                AppNavigator.navigateTo(ForgerPassword());
              },
            ),
          ],
        ),
        ...
        SizedBox(
          height: AppSizer.getHeight(80),
        ),
        CustomButton(
          text: AppString.TEXT_SIGNIN,
          onTap: () {
