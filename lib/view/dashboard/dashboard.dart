...
import 'package:ycsh/view/dashboard/home/about_us.dart';
...
class _DashboardScreenState extends State<DashboardScreen> {
  ...
  void onInit() {
    screens = [
      //FavouriteProductScreen(back_enabled: false,),
      HomeScreen(
  ...
  Widget build(BuildContext context) {
    ...
    return CustomBackground(
        safe: false,
        bgColor:
            Platform.isIOS ? AppColor.THEME_COLOR_PRIMARY1 : AppColor.BG_COLOR,
        child: Scaffold(
          key: _drawerKey,
          ...
          body: PageView.builder(
              ...
              itemBuilder: (con, ind) {
                ...
                return _forward
                    ? (ind == 0 ? screens[_prev_sel] : screens[selected])
    ...
    return CustomDrawer(
      ...
      items: [
        DrawerItem(
          ...
          icon: AssetPath.ICON_HOME2,
        ),
        DrawerItem(
          title: AppString.TEXT_CART,
          icon: AssetPath.ICON_DINER,
          onTap: () {
            goTo(CartScreen());
          },
        ),
        DrawerItem(
            ...
            icon: AssetPath.ICON_HEART,
            onTap: () {
              goTo(FavouriteProductScreen());
            }),
        DrawerItem(
          title: AppString.TEXT_ACTIVE_ORDERS,
        ...
        DrawerItem(
            title: AppString.TEXT_ORDER_HISTORY,
            icon: AssetPath.ICON_DINER,
            onTap: () {
        ...
        DrawerItem(
            ...
            icon: AssetPath.ICON_USER,
            onTap: () {
              goTo(ProfileScreen());
            }),
        DrawerItem(
            title: AppString.TEXT_ADDRESSES,
            icon: AssetPath.ICON_LOCATION2,
            onTap: () {
              goTo(AddressScreen());
            }),
        ...
        DrawerItem(
            title: AppString.TEXT_ADD_CARDS,
            icon: AssetPath.ICON_CARD,
            onTap: () {
              goTo(CardScreen());
              //goTo(EventScreen());
            }),
        ...
        DrawerItem(
            title: AppString.TEXT_CONTACT_US,
            icon: AssetPath.ICON_PHONE,
            onTap: () {
        ...
        DrawerItem(
            title: AppString.TEXT_ABOUT_US,
            icon: AssetPath.ICON_INFO,
            onTap: () {
              goTo(AboutUsScreen());
            }),
    ...
    return DashboardNavigationBar(
      ...
      items: [
        DashboardNavigationBarItem(
          title: AppString.TEXT_HOME,
          icon:
              selected == 0 ? AssetPath.ICON_HOME_FILLED : AssetPath.ICON_HOME,
          selected: selected == 0,
          onTap: () {
            select(0);
          },
        ...
        DashboardNavigationBarItem(
          title: AppString.TEXT_CART,
          icon: selected == 1
              ? AssetPath.ICON_DINER_FILLED
              : AssetPath.ICON_DINER,
          selected: selected == 1,
          onTap: () {
            select(1);
          },
        ...
        DashboardNavigationBarItem(
          title: AppString.TEXT_FAVOURITES,
          icon: selected == 2
              ? AssetPath.ICON_HEART_FILLED
              : AssetPath.ICON_HEART,
          selected: selected == 2,
          onTap: () {
            select(2);
          },
        ...
        DashboardNavigationBarItem(
          title: AppString.TEXT_PROFILE,
          icon:
              selected == 3 ? AssetPath.ICON_USER_FILLED : AssetPath.ICON_USER,
          selected: selected == 3,
          onTap: () {
            select(3);
          },
    ...
    if (selected != _prev_sel) {
      setState(() {
        ...
        _pageController.animateToPage(_forward ? 1 : 0,
            duration:
                const Duration(milliseconds: AppInteger.SWIPE_DURATION_MILLI),
            curve: Curves.linear);
      });
    }
  }
